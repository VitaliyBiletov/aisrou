...
const renderCustomizedLabel = (props) => {
    ...
    return (
        <g>
            <text style={{textShadow: "2px 2px #c7e3ff"}} x={width + x + 30} y={y + 25} fill="#1e90ff"
                  textAnchor="middle"
                ...
                {diagramData ?
                    <div className="result__diagram">
                        <BarChart barCategoryGap={5} layout="vertical" width={800} height={500} data={diagramData}
                            ...
                            />
                            <Tooltip/>
                            <Bar background={{fill: '#dff1e6'}} minPointSize={5} type="monotone" dataKey="Результат"
                                 fill="#4cb373">
                            ...
                            <div key={index}>
                                ...
                                <ul>
                                    {Object.keys(translateTitle.reading[key].data).map((name, index) => {
                                        return state.reading.skills[key][name] ?
                            ...
                            <div key={index}>
                                ...
                                <ul>
                                    {Object.keys(translateTitle.writing[key].data).map((name, index) => {
                                        return state.writing.skills[key][name] ?
