...
//Форма редактирования. Отобржанеие в зависимоти от типа (диагностика, пользователи, ученики)
            ...
            <div className='modal__container'>
                {isLoading ?
                    <form className='modal__form form'>
                        ...
                        {type === 'diagnostics' ?
                            <select className='form__input' onChange={handleChange} value={formData['typeId']}
                                    name="typeId">
                            ...
                            : null}
                        {type === 'users' ?
                            <select className='form__input' onChange={handleChange} value={formData['role']}
                                    name="role">
